...
lclMIAllSchool <- localmoran(SPClusterMSOA@data$SchoolDensity, SpWeightsMSOA)
lclMIAllGP <- localmoran(SPClusterMSOA@data$GPDensity, SpWeightsMSOA)
lclMIAllHospital <- localmoran(SPClusterMSOA@data$HospitalDensity, SpWeightsMSOA)
lclMINO2School <- localmoran(SPClusterMSOA@data$SchoolNO2Density, SpWeightsMSOA)
lclMINO2GP <- localmoran(SPClusterMSOA@data$GPNO2Density, SpWeightsMSOA)
lclMINO2Hospital <- localmoran(SPClusterMSOA@data$HospitalNO2Density, SpWeightsMSOA)
lclMIPM2.5School <- localmoran(SPClusterMSOA@data$SchoolPM2.5Density, SpWeightsMSOA)
lclMIPM2.5GP <- localmoran(SPClusterMSOA@data$GPPM2.5Density, SpWeightsMSOA)
lclMIPM2.5Hospital <- localmoran(SPClusterMSOA@data$HospitalPM2.5Density, SpWeightsMSOA)
...
SFMSOA$`IMD NO2 Coef.`<- GWRNO2Results$X.IMD.Score.
SFMSOA$`Income NO2 Coef.`<- GWRNO2Results$X.Income.Score.
SFMSOA$`Employment NO2 Coef.`<- GWRNO2Results$X.Employment.Score.
SFMSOA$`Education NO2 Coef.`<- GWRNO2Results$X.Education.Score.
SFMSOA$`Health NO2 Coef.`<- GWRNO2Results$X.Health.Score.
SFMSOA$`Crime NO2 Coef.`<- GWRNO2Results$X.Crime.Score.
SFMSOA$`Housing NO2 Coef.`<- GWRNO2Results$X.Housing.Score.
SFMSOA$`Environment NO2 Coef.`<- GWRNO2Results$X.Environment.Score.

SFMSOA$`IMD PM2.5 Coef.`<- GWRPM2.5Results$X.IMD.Score.
SFMSOA$`Income PM2.5 Coef.`<- GWRPM2.5Results$X.Income.Score.
SFMSOA$`Employment PM2.5 Coef.`<- GWRPM2.5Results$X.Employment.Score.
SFMSOA$`Education PM2.5 Coef.`<- GWRPM2.5Results$X.Education.Score.
SFMSOA$`Health PM2.5 Coef.`<- GWRPM2.5Results$X.Health.Score.
SFMSOA$`Crime PM2.5 Coef.`<- GWRPM2.5Results$X.Crime.Score.
SFMSOA$`Housing PM2.5 Coef.`<- GWRPM2.5Results$X.Housing.Score.
SFMSOA$`Environment PM2.5 Coef.`<- GWRPM2.5Results$X.Environment.Score.
