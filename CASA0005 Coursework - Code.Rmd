...
PollutionFiles <- list.files("Data/Air Pollution/LAEI 2016 Concentrations/Rasters", ".tif", full.names = TRUE)
...
CodePointsFiles <- list.files(path = "Data/Schools and Health/OS Point Codes/Data/CSV", full.names=TRUE)
